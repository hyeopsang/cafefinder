...
const SearchForm = ({ currentLocation, setIsOpen }: SearchFormProps) => {
  ...
  return (
    <form
      className="absolute top-5 left-1/2 z-10 flex w-[90%] -translate-x-1/2 items-center justify-between rounded-xl bg-white px-2 py-1 shadow-md"
      id="search_form"
    ...
    >
      ...
      <input
        type="text"
        id="keyword"
        className="flex-grow bg-white text-sm outline-none"
        value={searchTxt}
