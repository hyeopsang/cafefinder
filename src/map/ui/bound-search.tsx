...
export default function BoundSearch({ setShowReGps, showReGps }: BoundSearchProps) {
    ...
    return (
        <div 
            className="absolute left-0 right-0 m-auto top-25 z-30 w-fit h-fit px-4 py-2 rounded-full bg-white shadow-md flex items-center justify-center cursor-pointer" 
