...
export default function BoundSearch({ setSearchTxt, setShowReGps } : { setSearchTxt : React.Dispatch<React.SetStateAction<string>>, setShowReGps : React.Dispatch<React.SetStateAction<boolean>> } ){
